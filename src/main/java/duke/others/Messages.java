...
public class Messages {
    ...
    public static final String NOTES_ADD = "Notes added successfully! :3";
    public static final String NOTES_UPDATE = "Notes updated successfully! :3";
    public static final String NOTES_DELETE = "Notes deleted successfully! :3";
}
